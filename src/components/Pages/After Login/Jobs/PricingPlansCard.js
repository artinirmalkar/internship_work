...
const PricingPlansCard = () => {
   ...
   {title:"25  Jobs per month", mPrice:"TZS 102000.00", aPrice:"TZS 1000000.00"},
   {title:"25  Jobs per month", mPrice:"TZS 102000.00", aPrice:"TZS 1000000.00"},
   {title:"25  Jobs per month", mPrice:"TZS 102000.00", aPrice:"TZS 1000000.00"},
   {title:"25  Jobs per month", mPrice:"TZS 102000.00", aPrice:"TZS 1000000.00"},
   {title:"25  Jobs per month", mPrice:"TZS 102000.00", aPrice:"TZS 1000000.00"},
...
const handleOnClick = () => {
  ...
  <div className="cardprice" style={{display:"flex", flexWrap:"wrap", justifyContent:"center", textAlign:"center", position:"relative", lineHeight:"50px"}}>
  {details.map((items,i)=>(
...
<Button className="chooseplanbtn" onClick={handleOnClick} size="sm">
      Choose Plan
        </Button>{' '}
